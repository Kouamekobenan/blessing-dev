      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Avec plus de 3 années d&apos;expérience dans le développement web
              et plusieurs projets réalisés avec succès, BlessingDev accompagne
              les entreprises, les entrepreneurs et les organisations dans leur
          ...
          <div
            className="lg:flex justify-center items-center animate-scale-in"
            style={{ animationDelay: "0.3s" }}
          >
            <div className="relative w-85 h-85">
              <div
                className="absolute inset-0 rounded-full border border-pink-400/20 dark:border-pink-500/20"
                style={{ animation: "spin 22s linear infinite" }}
              />
              <div
                className="absolute inset-6 rounded-full border border-pink-300/10 dark:border-pink-500/10"
                style={{ animation: "spin 16s linear infinite reverse" }}
              />
              <div
                className="absolute inset-12 rounded-full border border-slate-300/40 dark:border-slate-700/40"
                style={{ animation: "spin 30s linear infinite" }}
              />
              <div className="absolute inset-16 rounded-2xl overflow-hidden shadow-md dark:shadow-none border border-slate-200 dark:border-slate-700/50 group">
                {/* L'image prend 100% du cadre */}
                <Image
                  ...
                  priority
                />
                {/* Conteneur overlay pour le texte en bas ou centré */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col items-center justify-end p-6 gap-1">
                  <div className="text-center">
                    <div className="text-white font-bold text-base tracking-wide drop-shadow-md">
                      BlessingDev
                    </div>
                    <div className="text-pink-400 font-medium text-xs tracking-wider uppercase drop-shadow-md">
                      Web &amp; Mobile
                    </div>
                  </div>
                </div>
